...
- Design tokens: `src/styles/tokens.css` is the **single source of truth** (the
  old repo-root `styles/tokens.css` was removed 2026-07-20). Prefer token
  variables over ad-hoc hex/rem.
