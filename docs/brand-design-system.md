...
Companions: [`personal-evidence-graph.md`](personal-evidence-graph.md) (product + Naming), [`surfaces-and-flows.md`](surfaces-and-flows.md) (what to style), [`mockup-synthesis.md`](mockup-synthesis.md) (Graph-home vision brief), [`building-plan.md`](building-plan.md) (**U-A**). **Code:** [`styles/tokens.css`](../styles/tokens.css).

Status: **U-A look locked** — tokens in `styles/tokens.css`. Motion / full a11y / app restyle deferred until greenfield build after **U-J**. Keep growing §12 Do/don’t.
...
- [x] Spacing / radius / panel+modal widths + semantic hex in [`styles/tokens.css`](../styles/tokens.css)
...
**Code reference:** [`styles/tokens.css`](../styles/tokens.css). Prefer these variables over inventing values when the app is bootstrapped.
...
- [x] Node / edge / glass / semantic / focus tokens in [`styles/tokens.css`](../styles/tokens.css)
...
*Code reference:* [`styles/tokens.css`](../styles/tokens.css).
...
| 2026-07-15 | Spacing 4→64; radius 10/12/14; panel 320 / modal 520; semantic `#2f9e6a` / `#c4473a` (+ dark); code ref [`styles/tokens.css`](../styles/tokens.css) |
| 2026-07-15 | Prototype Next app removed; tokens live at `styles/tokens.css`. U-A look locked; trailers deferred |
...
- **2026-07-15:** Removed Next.js prototype scaffold; tokens moved to [`styles/tokens.css`](../styles/tokens.css). U-A look locked; motion/a11y/app wire deferred.
- **2026-07-15:** Locked spacing/radius/chrome widths + semantic Confirm/Discard hex; code reference [`styles/tokens.css`](../styles/tokens.css).
