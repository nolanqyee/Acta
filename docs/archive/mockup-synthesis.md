...
1. **Before redrawing** `brand-mockups.html` (or Figma / real UI): re-read this + surfaces § Graph home + [`src/styles/tokens.css`](../src/styles/tokens.css).
...
- **2026-07-20:** Repointed token code reference to [`src/styles/tokens.css`](../src/styles/tokens.css) after U-J moved to a single Next.js app (was `acta-web/src/styles/tokens.css`).
- **2026-07-15:** Pointed visual locks at code reference `src/styles/tokens.css` (spacing, semantic hex, panel/modal widths).
