...
- **2026-07-14:** Working brand → **Acta**. U-A visual system specified up front, then scrapped for rebuild-from-screen. Name locked; visual sections open. Then U-J → capture+render → U-E.
